  ...
  return (
    ...
    >
      ...
      <div className={'flex flex-col gap-2 '}>
        ...
        <div>
          <a href="mailto:wohohiame@okbfoundation.org" className={linkClasses}
             style={linkStyles}>wohohiame@okbfoundation.org</a>
      ...
      <div className={'flex flex-col gap-2 lg:gap-4  text-sm font-bold items-end text-end'}>
        ...
        <div className={'flex gap-4'}>
          <span>
            <button>
              <a style={{color: 'white'}} href="https://www.instagram.com/wohohiame/">
...
<path
  ...
  fill="white"/>
          ...
          <span>
            <button>
                            <a style={{color: 'white'}} href="https://www.facebook.com/profile.php?id=100086186303060">
...
{/*              <svg width="43" height="31" viewBox="0 0 43 31" fill="none" xmlns="http://www.w3.org/2000/svg">*/}
              ...
              {/*</svg>*/}
              <a style={{color: 'white'}} href="https://twitter.com/wohohiame">
