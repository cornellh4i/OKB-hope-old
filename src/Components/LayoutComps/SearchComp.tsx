    ...
    <div className={'pt-6 md:pr-10 w-full bg-[#EDF3F8]'}>
      ...
      <div className={'w-full mx-auto flex justify-center px-3'}>
        <form onSubmit={searchHandler}>
          <input autoFocus={true} ref={searchRef}
                 className={'px-4 text-xl h-12 w-11/12 translate-x-2 border rounded-full'} type="text"/>
      ...
      <div className={'flex justify-end w-full cursor-pointer'} onClick={
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill={'currentColor'} height="40" width="40"><path d="m10.458 31.458-1.916-1.916 9.5-9.542-9.5-9.542 1.916-1.916 9.542 9.5 9.542-9.5 1.916 1.916-9.5 9.542 9.5 9.542-1.916 1.916-9.542-9.5Z"/></svg>
      </div>
